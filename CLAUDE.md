...
```css
--brand-cyan: #4fb6ff /* the "G" cyan */ --brand-blue: #4d89ff
  /* mid blue, same as --primary */ --brand-purple: #8b5cf6
  /* the "b" + git-branch icon purple */
...
--primary: #4d89ff /* main blue accent — same as --brand-blue */
  ...
  --primary-glow: rgba(77, 137, 255, 0.45) --bg-base: #020208
  --bg-surface: #06060f --bg-card: #0b0b1a --text-primary: #f0f0f5
  --text-secondary: #9a9ab0 --text-muted: #6a6a82
  /* bumped from #44445a for WCAG contrast */;
```
...
```css
--font-display: "Manrope" /* headings, section titles */ --font-body: "DM Sans"
  /* body text, UI labels, tags */ --font-mono: "JetBrains Mono"
  /* code snippets, tech glyphs */;
```
